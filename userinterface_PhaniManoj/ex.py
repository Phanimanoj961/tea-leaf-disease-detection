...
image_dir = 'c:\\Users\\phani\\OneDrive\\Desktop\\projects\\Tea_leaf_Disease_Detection\\tea_sickness_dataset'  # Replace with your dataset directory path
...
page = st.sidebar.radio("Go to", ["Home", "Detect Disease"])
